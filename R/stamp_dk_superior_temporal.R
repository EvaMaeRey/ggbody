...
#'  stamp_dk_superior_temporal(fill = 'pink')
#'
stamp_dk_superior_temporal <- function(hemi = NULL, side = NULL, ...) {

stamp_dk_brain(hemi = hemi, side = side, region = 'superior temporal', ...)
