...
#'  stamp_dk_transverse_temporal(fill = 'pink')
#'
stamp_dk_transverse_temporal <- function(hemi = NULL, side = NULL, ...) {

stamp_dk_brain(hemi = hemi, side = side, region = 'transverse temporal', ...)
