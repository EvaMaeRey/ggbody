...
#'  stamp_dk_lateral_orbitofrontal(fill = 'pink')
#'
stamp_dk_lateral_orbitofrontal <- function(hemi = NULL, side = NULL, ...) {

stamp_dk_brain(hemi = hemi, side = side, region = 'lateral orbitofrontal', ...)
