...
#'  stamp_dk_superior_parietal(fill = 'pink')
#'
stamp_dk_superior_parietal <- function(hemi = NULL, side = NULL, ...) {

stamp_dk_brain(hemi = hemi, side = side, region = 'superior parietal', ...)
