...
#'  stamp_dk_pars_triangularis(fill = 'pink')
#'
stamp_dk_pars_triangularis <- function(hemi = NULL, side = NULL, ...) {

stamp_dk_brain(hemi = hemi, side = side, region = 'pars triangularis', ...)
