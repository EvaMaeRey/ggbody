...
#'  stamp_dk_inferior_temporal(fill = 'pink')
#'
stamp_dk_inferior_temporal <- function(hemi = NULL, side = NULL, ...) {

stamp_dk_brain(hemi = hemi, side = side, region = 'inferior temporal', ...)
