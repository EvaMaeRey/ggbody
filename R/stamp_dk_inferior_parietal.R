...
#'  stamp_dk_inferior_parietal(fill = 'pink')
#'
stamp_dk_inferior_parietal <- function(hemi = NULL, side = NULL, ...) {

stamp_dk_brain(hemi = hemi, side = side, region = 'inferior parietal', ...)
