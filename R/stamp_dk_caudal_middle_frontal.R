...
#'  stamp_dk_caudal_middle_frontal(fill = 'pink')
#'
stamp_dk_caudal_middle_frontal <- function(hemi = NULL, side = NULL, ...) {

stamp_dk_brain(hemi = hemi, side = side, region = 'caudal middle frontal', ...)
