...
#'  stamp_dk_medial_orbitofrontal(fill = 'pink')
#'
stamp_dk_medial_orbitofrontal <- function(hemi = NULL, side = NULL, ...) {

stamp_dk_brain(hemi = hemi, side = side, region = 'medial orbitofrontal', ...)
