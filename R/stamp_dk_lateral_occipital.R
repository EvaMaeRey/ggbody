...
#'  stamp_dk_lateral_occipital(fill = 'pink')
#'
stamp_dk_lateral_occipital <- function(hemi = NULL, side = NULL, ...) {

stamp_dk_brain(hemi = hemi, side = side, region = 'lateral occipital', ...)
