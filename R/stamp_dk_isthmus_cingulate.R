...
#'  stamp_dk_isthmus_cingulate(fill = 'pink')
#'
stamp_dk_isthmus_cingulate <- function(hemi = NULL, side = NULL, ...) {

stamp_dk_brain(hemi = hemi, side = side, region = 'isthmus cingulate', ...)
