...
#'  stamp_dk_posterior_cingulate(fill = 'pink')
#'
stamp_dk_posterior_cingulate <- function(hemi = NULL, side = NULL, ...) {

stamp_dk_brain(hemi = hemi, side = side, region = 'posterior cingulate', ...)
