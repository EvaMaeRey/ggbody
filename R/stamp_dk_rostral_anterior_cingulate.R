...
#'  stamp_dk_rostral_anterior_cingulate(fill = 'pink')
#'
stamp_dk_rostral_anterior_cingulate <- function(hemi = NULL, side = NULL, ...) {

stamp_dk_brain(hemi = hemi, side = side, region = 'rostral anterior cingulate', ...)
